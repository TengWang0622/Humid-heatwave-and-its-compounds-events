...
# Description: Identify and tabulate all the Pure humid heatwave events dataframe, 
...
#df$checkIndex=ifelse(df$Index >= 1.34, 1, 0)  #####87.5%####
...
id_row=seq(1,length(df$checkONLYheat),by=No_subgroup)# -------------Modify the variable to consider heatwave，precipitation or compound: df$checkEvent, df$checkPrecip, df$checkCompound
...
saveRDS(prepost,'/Users/wangteng/Downloads/ChinaHeat.rds')
